...
# Tiempos de control (aumentados para rango servo 0-180° completo)
DURACION_MAX_GIRO_SEG = 5.0
DURACION_MIN_GIRO_SEG = 2.0
TIEMPO_COOLDOWN_ESQUINA_SEG = 2.0
DURACION_ESQUIVA_SEG = 2.5
DURACION_MIN_ESQUIVA_SEG = 1.0
